...
const AllDonationRequests = () => {
  ...
  const {
    ...
    queryKey: ["all-donation-requests", filter, page],
    queryFn: async () => {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <select
              className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 text-sm focus:ring-blue-500 focus:border-blue-500"
              value={filter}
              onChange={(e) => {
